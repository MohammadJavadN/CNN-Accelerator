...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_img_out_V_V \
    op interface \
    ports { img_out_V_V_din { O 14 vector } img_out_V_V_full_n { I 1 bit } img_out_V_V_write { O 1 bit } } \
} "
}
