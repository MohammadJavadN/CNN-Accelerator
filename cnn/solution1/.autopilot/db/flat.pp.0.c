...
(
  ...
  float flat_array [(10 * ((((28 - (5 - 1)) / 2) - (5 - 1)) / 2) * ((((28 - (5 - 1)) / 2) - (5 - 1)) / 2))]
);
# 2 "lib/flat.c" 2
...
{_ssdm_SpecArrayDimSize(pool_features, 10);_ssdm_SpecArrayDimSize(flat_array, 160);
  int index = 0;

  for(int f = 0; f < 10; ++f)
    for(int r = 0; r < ((((28 - (5 - 1)) / 2) - (5 - 1)) / 2); ++r)
      for(int c = 0; c < ((((28 - (5 - 1)) / 2) - (5 - 1)) / 2); ++c)
      {
