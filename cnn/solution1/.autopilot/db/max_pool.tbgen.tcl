...
set C_modelArgList {
	{ feature_0_V int 13 regular {array 576 { 1 3 } 1 1 }  }
	{ feature_1_V int 13 regular {array 576 { 1 3 } 1 1 }  }
	{ feature_2_V int 13 regular {array 576 { 1 3 } 1 1 }  }
	{ feature_3_V int 13 regular {array 576 { 1 3 } 1 1 }  }
	{ feature_4_V int 13 regular {array 576 { 1 3 } 1 1 }  }
	{ feature_5_V int 13 regular {array 576 { 1 3 } 1 1 }  }
	{ feature_V_offset int 3 regular  }
	{ pool_feature_V int 14 regular {array 864 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "feature_0_V", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "feature_1_V", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "feature_2_V", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "feature_3_V", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "feature_4_V", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "feature_5_V", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ pool_feature_V_d0 sc_out sc_lv 14 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "feature_0_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "feature_0_V", "role": "q0" }} , 
 	...
 	{ "name": "feature_1_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "feature_1_V", "role": "q0" }} , 
 	...
 	{ "name": "feature_2_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "feature_2_V", "role": "q0" }} , 
 	...
 	{ "name": "feature_3_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "feature_3_V", "role": "q0" }} , 
 	...
 	{ "name": "feature_4_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "feature_4_V", "role": "q0" }} , 
 	...
 	{ "name": "feature_5_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "feature_5_V", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_mux_63_14_1_1_U17", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	feature_0_V { ap_memory {  { feature_0_V_address0 mem_address 1 10 }  { feature_0_V_ce0 mem_ce 1 1 }  { feature_0_V_q0 mem_dout 0 13 } } }
	feature_1_V { ap_memory {  { feature_1_V_address0 mem_address 1 10 }  { feature_1_V_ce0 mem_ce 1 1 }  { feature_1_V_q0 mem_dout 0 13 } } }
	feature_2_V { ap_memory {  { feature_2_V_address0 mem_address 1 10 }  { feature_2_V_ce0 mem_ce 1 1 }  { feature_2_V_q0 mem_dout 0 13 } } }
	feature_3_V { ap_memory {  { feature_3_V_address0 mem_address 1 10 }  { feature_3_V_ce0 mem_ce 1 1 }  { feature_3_V_q0 mem_dout 0 13 } } }
	feature_4_V { ap_memory {  { feature_4_V_address0 mem_address 1 10 }  { feature_4_V_ce0 mem_ce 1 1 }  { feature_4_V_q0 mem_dout 0 13 } } }
	feature_5_V { ap_memory {  { feature_5_V_address0 mem_address 1 10 }  { feature_5_V_ce0 mem_ce 1 1 }  { feature_5_V_q0 mem_dout 0 13 } } }
	feature_V_offset { ap_none {  { feature_V_offset in_data 0 3 } } }
	pool_feature_V { ap_memory {  { pool_feature_V_address0 mem_address 1 10 }  { pool_feature_V_ce0 mem_ce 1 1 }  { pool_feature_V_we0 mem_we 1 1 }  { pool_feature_V_d0 mem_din 1 14 } } }
}
