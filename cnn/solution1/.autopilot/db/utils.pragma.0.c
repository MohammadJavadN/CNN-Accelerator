...
{_ssdm_SpecArrayDimSize(img_in, 28);_ssdm_SpecArrayDimSize(img_out, 32);
  for(int r = 0; r < (28 + (5 - 1)); ++r)
    for(int c = 0; c < (28 + (5 - 1)); ++c)
    {
      if (r == 0 || r == 28 + 1)
      {
...
{_ssdm_SpecArrayDimSize(img_in, 28);_ssdm_SpecArrayDimSize(img_out, 28);
  for(int r = 0; r < 28; ++r)
    for(int c = 0; c < 28; ++c)
    {
