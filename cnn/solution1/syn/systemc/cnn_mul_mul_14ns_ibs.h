...
// ==============================================================
#ifndef __cnn_mul_mul_14ns_ibs__HH__
#define __cnn_mul_mul_14ns_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_mul_14ns_ibs) {
    ...
    SC_CTOR(cnn_mul_mul_14ns_ibs):  ACMP_smul_us_U ("ACMP_smul_us_U") {
