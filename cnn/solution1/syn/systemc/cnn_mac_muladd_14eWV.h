...
// ==============================================================
#ifndef __cnn_mac_muladd_14eWV__HH__
#define __cnn_mac_muladd_14eWV__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14eWV) {
    ...
    SC_CTOR(cnn_mac_muladd_14eWV):  simcore_mac_14_U ("simcore_mac_14_U") {
