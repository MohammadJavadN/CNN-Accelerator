...
// ==============================================================
#ifndef __cnn_mac_muladd_14eXV__HH__
#define __cnn_mac_muladd_14eXV__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14eXV) {
    ...
    SC_CTOR(cnn_mac_muladd_14eXV):  simcore_mac_15_U ("simcore_mac_15_U") {
