...
// ==============================================================
#ifndef __cnn_mac_muladd_14ePU__HH__
#define __cnn_mac_muladd_14ePU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14ePU) {
    ...
    SC_CTOR(cnn_mac_muladd_14ePU):  simcore_mac_9_U ("simcore_mac_9_U") {
