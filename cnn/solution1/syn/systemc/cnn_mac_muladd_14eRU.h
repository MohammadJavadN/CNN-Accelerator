...
// ==============================================================
#ifndef __cnn_mac_muladd_14eRU__HH__
#define __cnn_mac_muladd_14eRU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14eRU) {
    ...
    SC_CTOR(cnn_mac_muladd_14eRU):  simcore_mac_11_U ("simcore_mac_11_U") {
