...
// ==============================================================
#ifndef __cnn_mac_muladd_14eOU__HH__
#define __cnn_mac_muladd_14eOU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14eOU) {
    ...
    SC_CTOR(cnn_mac_muladd_14eOU):  simcore_mac_8_U ("simcore_mac_8_U") {
