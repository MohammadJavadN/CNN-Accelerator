...
// ==============================================================
#ifndef __cnn_mac_muladd_14eGT__HH__
#define __cnn_mac_muladd_14eGT__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mac_muladd_14eGT) {
    ...
    SC_CTOR(cnn_mac_muladd_14eGT):  simcore_mac_0_U ("simcore_mac_0_U") {
