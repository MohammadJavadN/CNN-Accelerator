...
// ==============================================================
#ifndef __cnn_fcmp_32ns_32nbkb__HH__
#define __cnn_fcmp_32ns_32nbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_fcmp_32ns_32nbkb) {
    ...
    SC_CTOR(cnn_fcmp_32ns_32nbkb):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
