...
architecture rtl of cnn_conv2_biases_V_rom is 
...
architecture arch of cnn_conv2_biases_V is
    component cnn_conv2_biases_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cnn_conv2_biases_V_rom_U :  component cnn_conv2_biases_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
